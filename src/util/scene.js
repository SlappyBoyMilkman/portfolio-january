...
class Scene extends SystemBase{
  ...
  initialize(){
    ...
    this.three.scene.fog = new THREE.Fog( this.color, 1000, 1700 );
    ...
    if( !this.locked ){
      ...
      if( Math.abs( scrolled ) > 150 ){
          if( scrolled > 0 ){
            ...
            this.three.scene.fog.color = new THREE.Color( `rgb(${ this.nextColor.r }, ${ this.nextColor.g }, ${ this.nextColor.b })` );
